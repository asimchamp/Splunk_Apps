require([
    ...
    $(add_credential_keys).click(function(e) {
        ...
        $(ck_div).append('<div name="ck_input"><p class="helpText"><br>Kafka Username<br><input autocomplete="off"  type="text" size="20" name="mycredkey[]"/><a href="#" class="remove_field">  Remove</a><br><br>Password<br><input autocomplete="off"  type="password" size="20" name="mycred[]"/></p></div>');
    ...
    $.ajax({
        type: "GET",
        url: "../../../../en-US/splunkd/__raw/services/kafkamodinput/kafkamodinputsetup/kafkamodinput?output_mode=json",
        success: function(text) {
            ...
            for (var i = 0; i < credentialKeyItems.length; i++) {
                ...
                $(ck_div).append('<div name="ck_input"><p class="helpText"><br>Kafka Username<br><input autocomplete="off"  type="text" size="20" name="mycredkey[]" value="' + credentialKeyItems[i] + '"/><a href="#" class="remove_field">  Remove</a><br><br>Password<br><input autocomplete="off"  type="password" size="20" name="mycred[]" value="' + credentialItems[i] + '"/></p></div>');
    ...
    $(submit_button).click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../../../en-US/splunkd/__raw/services/kafkamodinput/kafkamodinputsetup/kafkamodinput",
