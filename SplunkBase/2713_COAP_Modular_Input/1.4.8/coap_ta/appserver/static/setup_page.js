require([
    ...
    $.ajax({
        type: "GET",
        url: "../../../../en-US/splunkd/__raw/services/coapmodinput/coapmodinputsetup/coapmodinput?output_mode=json",
    ...
    $(submit_button).click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../../../en-US/splunkd/__raw/services/coapmodinput/coapmodinputsetup/coapmodinput",
            ...
            success: function(text) {
                ...
                window.location.href = '../coap_ta/landing';
