...
class ModSnowIncident(sib.SnowIncidentBase):
    ...
    def _get_correlation_id(self, event):
        ...
        return hashlib.md5(  # nosemgrep: python.lang.security.insecure-hash-algorithms.insecure-hash-algorithm-md5, gitlab.bandit.B303-1, contrib.dlint.dlint-equivalent.insecure-hashlib-use  # noqa: E501
            unique_name.encode()
        ).hexdigest()
