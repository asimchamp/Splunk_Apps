...
from subprocess import (  # nosemgrep: gitlab.bandit.B404 - usages aren't used in the code  # isort: skip
    PIPE,
    Popen,
)
...
def _do_timed_popen(args, timeout):
    ...
    # semgrep ignore reason: not used in TA as of this commit.
    # If used in future make sure it is not controllable by an external resource
    sub = Popen(  # nosemgrep: python.lang.security.audit.dangerous-subprocess-use.dangerous-subprocess-use
