...
def log_enter_exit(logger):
    ...
    def log_decorator(func):
        # semgrep ignore reason: wrapper is used on line 34 when `log_decorator` is called
        def wrapper(  # nosemgrep: python.lang.maintainability.useless-innerfunction.useless-inner-function
            *args, **kwargs
        ):
