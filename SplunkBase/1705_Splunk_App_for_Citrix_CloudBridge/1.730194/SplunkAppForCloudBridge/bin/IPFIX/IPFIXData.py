...
class Data:
    @staticmethod
    def readVariableLengthString(data, dataTypeName):
        """
        ...
        if dataTypeName == 'string':
            ...
            return str(data).rstrip("\x00").encode('hex'), length + start, length
        ...
        for field in template:
            ...
            try:
                if field.length == 65535:
                    data, length, stringlength = self.readVariableLengthString(rawData[start:], field.dataTypeName)
