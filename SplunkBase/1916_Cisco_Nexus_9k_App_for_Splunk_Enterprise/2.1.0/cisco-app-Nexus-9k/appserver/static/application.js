$(document).ready(function () {
    ...
    let host_input = $("#\\/admin\\/cisco_Nexus_9k_server_setup\\/cisco_Nexus_9k_server_setup_settings\\/cisco_Nexus_9k_host_id")
    let host_error_widget = $(host_input).siblings('div')[0]
    let username_input = $("#\\/admin\\/cisco_Nexus_9k_server_setup\\/cisco_Nexus_9k_server_setup_settings\\/cisco_Nexus_9k_username_id");
    let username_error_widget = $(username_input).siblings('div')[0]
    let password_input = $("#\\/admin\\/cisco_Nexus_9k_server_setup\\/cisco_Nexus_9k_server_setup_settings\\/password_id")
