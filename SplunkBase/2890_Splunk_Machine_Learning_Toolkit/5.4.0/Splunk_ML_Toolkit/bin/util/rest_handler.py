...
from util.formdata_util import process_formdata_request
...
class RestHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        if type(in_string) == bytes and b'"Content-Type","multipart/form-data' in in_string:
            request = process_formdata_request(in_string)
        else:
