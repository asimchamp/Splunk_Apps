require([
    ...
    $.ajax({
        type: "GET",
        url: "../../../../en-US/splunkd/__raw/services/ak_kinesismodinput/ak_kinesismodinputsetup/activationkey?output_mode=json",
    ...
    $(submit_button).click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../../../en-US/splunkd/__raw/services/ak_kinesismodinput/ak_kinesismodinputsetup/activationkey",
