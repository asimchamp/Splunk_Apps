...
def get_server_dict_to_xml(server_dict, server_name):
    ...
    server_et = etree.Element(  # nosemgrep false-positive : It just creates XML Element from the static string 'jmxserver'. It doesn't take any external/user inputs.
        "jmxserver"
    )
    ...
    out = etree.tostring(  # nosemgrep false-positive : the 'server_et' passed in tostring() is an valid XML Element which was created in line no.92. It doesn't take any external/user inputs.
