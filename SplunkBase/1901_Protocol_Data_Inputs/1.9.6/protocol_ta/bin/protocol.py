...
def run_java():
    ...
    java_args = [ JAVA_EXECUTABLE, "-classpath",CLASSPATH,"-Xms128m","-Xmx256m","-Dsplunk.securetransport.protocol="+SECURE_TRANSPORT,"-DSPLUNK_HOME="+SPLUNK_HOME,JAVA_MAIN_CLASS]
