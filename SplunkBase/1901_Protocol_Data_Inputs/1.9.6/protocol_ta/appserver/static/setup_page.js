require([
    ...
    $.ajax({
        type: "GET",
        url: "../../../../en-US/splunkd/__raw/services/protocolmodinput/protocolmodinputsetup/protocolmodinput?output_mode=json",
    ...
    $(submit_button).click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../../../en-US/splunkd/__raw/services/protocolmodinput/protocolmodinputsetup/protocolmodinput",
            ...
            success: function(text) {
                ...
                window.location.href = '../protocol_ta/landing';
