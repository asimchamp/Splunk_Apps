...
require([
    ...
    function setupPopupMenus() {
        ...
        context.attachToTable(trendChart, includeExcludeMenu);
        context.attachToChart(userTable, includeExcludeDrilldownMenu);
        context.attachToChart(documentTable, includeExcludeDrilldownMenu);
