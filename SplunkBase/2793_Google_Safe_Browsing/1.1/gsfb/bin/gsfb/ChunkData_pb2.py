...
_CHUNKDATA_PREFIXTYPE = descriptor.EnumDescriptor(
  name='PrefixType',
...
_CHUNKDATA = descriptor.Descriptor(
  name='ChunkData',
  full_name='ChunkData',
  filename=None,
  file=DESCRIPTOR,
