Splunk.Module.PDFScheduler = $.klass(Splunk.Module, {
                ...
                $(this).ajaxSubmit({
                    ...
                    'success': function(json) {
                        ...
                        if (json["success"]) {
                        	...
                        	messenger.send('info', "splunk.pdf_scheduler", json["message"]);
                        	
                        // If it was unsuccessful, then print an error message accordingly
                        } else {
                            messenger = Splunk.Messenger.System.getInstance();
                            messenger.send('error', "splunk.pdf_scheduler", _('ERROR - ') + json["message"] || json);
                        }
                    },
                    'dataType': 'json'
                });
    ...
    handleSubmitCallback: function() {
    	...
    	messenger.send('info', "splunk.pdf_scheduler", "Action succeeded");
