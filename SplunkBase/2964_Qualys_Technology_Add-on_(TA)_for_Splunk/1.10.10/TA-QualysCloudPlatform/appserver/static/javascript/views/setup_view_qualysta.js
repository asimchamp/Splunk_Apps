    ...
    function(Backbone, jquery, splunk_js_sdk) {
        ...
        var ExampleView = Backbone.View.extend({
            ...
            trigger_setup: function trigger_setup() {
                ...
                var pcrs_posture_num_threads = jquery("input[name=pcrs_posture_num_threads]").val();
                pcrs_posture_num_threads = this.sanitize_string(pcrs_posture_num_threads);
                ...
                var properties_to_update = {
                    ...
                    pcrs_posture_num_threads: pcrs_posture_num_threads,
            ...
            validate_inputs: function validate_inputs(ta_username, ta_password, ta_confirm_password, ca_pass, ca_pass_confirm, properties_to_update) {
                ...
                var pcrs_posture_num_threads_errors = this.validate_pcrs_posture_num_threads_input(properties_to_update['pcrs_posture_num_threads']);
                ...
                error_messages = error_messages.concat(pcrs_posture_num_threads_errors);
            ...
            validate_pcrs_posture_num_threads_input: function validate_pcrs_posture_num_threads_input(pcrs_posture_num_threads) {
                var error_messages = [];
                var is_pcrs_posture_num_threads_empty = typeof pcrs_posture_num_threads === "undefined" || pcrs_posture_num_threads === "";
                
                if (is_pcrs_posture_num_threads_empty == false) {
                    var is_number = this.is_number(pcrs_posture_num_threads);
                    if (is_number == false) {
                        error_message = "Number of threads for PCRS posture streaming api input should be between 2 to 10.";
                        error_messages.push(error_message);
                    } else if (pcrs_posture_num_threads < 2 || pcrs_posture_num_threads > 10) {
                        error_message = "Number of threads for PCRS posture streaming api input should be between 2 to 10.";
                        error_messages.push(error_message);
                    }
                } else {
            ...
            //Validate PCRS resolve host ids num threads
            validate_pcrs_num_threads_input: function validate_pcrs_num_threads_input(pcrs_num_threads) {
                ...
                if (is_pcrs_num_threads_empty == false) {
                    ...
                    if (is_number == false) {
                        error_message = "Number of threads for PCRS resolve host ids api input should be between 2 to 10.";
                        error_messages.push(error_message);
                    ...
                    error_message = "Number of threads for Policy Compliance Reporting Service input to resolve host ids should be between 2 to 10.";
                    error_messages.push(error_message);
                }
            ...
            get_template: function get_template() {
                template_string =
                                ...
                                "       <div class='row'>" +
                                "           <div class='col-25'>" +
                                "               <label>Number of threads for PCRS resolve host ids api (max 10)</label>" +
                                "           </div>" +
                                "           <div class='col-75'>" +
                                ...
                                "       <div class='row'>" +
                                "           <div class='col-25'>" +
                                "               <label>Number of threads for PCRS posture streaming api(max 10)</label>" +
                                "           </div>" +
                                "           <div class='col-75'>" +
                                "               <input type='text' id='pcrs_posture_num_threads' name='pcrs_posture_num_threads' />" +
                                "           </div>" +
                                "       </div>" +
                                "       <div class='row'>" +
                                "           <div class='col-25'>" +
