...
var _SplunkVisualizationBase = __webpack_require__(5);
...
exports.default = _SplunkVisualizationBase2.default.extend({
    ...
    updateView: function (data, config) {
        ...
        var minMagnitude = Infinity,
            maxMagnitude = -Infinity;

        var fieldNames = _underscore2.default.pluck(data.fields, 'name');
        var labelFieldIdx = fieldNames.indexOf(labelField);
        var valueFieldIdx = fieldNames.indexOf(valueField);
        (0, _underscore2.default)(data.rows).chain().map(function (result) {
            ...
            // Render the tag
            (0, _jquery2.default)('<a class="link" href="#" /> ').text(result.label + ' ').css({
                'font-size': size
            }).appendTo(el).click(function (e) {
                // register drilldown handler
                e.preventDefault();
                var payload = {
                    action: _SplunkVisualizationBase2.default.FIELD_VALUE_DRILLDOWN,
                    data: {}
                };
                payload.data[labelField] = _jquery2.default.trim((0, _jquery2.default)(e.target).text());
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* eslint-disable
        ...
        no-unused-vars,
------------------------------
SPL-222749 Eslint v3->v8 Upgrade + JS Linting Update
This is an auto-generated comment and is part of the Eslint v3->v8 upgrade.
The above linting rules are ignored for this file because fixing these fails
may introduce logic changes that may cause regressions and is out of scope
for the Eslint upgrade. If you're here from the future, it is encouraged
to remove the eslint-disable comment and attempt to fix the issue properly
instead of ignoring the linting error.
*/
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, Backbone) {
    const VisualizationError = function (message) {
    ...
    const SplunkVisualizationBase = function (el, appName, vizName, dataSources) {
        this.el = el;
        this._config = null;
        this._data = null;
    ...
    _.extend(SplunkVisualizationBase.prototype, Backbone.Events, {
        ...
        /**
         * Override to implement custom data combining logic
         *
         * It is required to implement this function if more than one data sources are
         * defined in visualizations.conf
         *
         * dataFromAllSources is a object with data source name as key
         *
         * dataFromAllSources = {
         ...
         * }
         *
         * The return value of this method will be passed to the formatData routine.
         *
         * The default implementation will return only primary data.
         *
         * @param {Object} dataFromAllSources The data in its raw form
         ...
         *
         * @param {Object} combinedData The combined data in its raw form
         * @param {Object} config The current config attributes
         * @returns {*}
         */
