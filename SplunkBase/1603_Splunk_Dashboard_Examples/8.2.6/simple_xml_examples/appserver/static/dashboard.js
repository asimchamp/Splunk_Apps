...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(21), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, i18n) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// https://cd.splunkdev.com/devplat/simplexml-examples/-/commit/54f11ca96e6c6207b95529d57f5ab19cafde3d75
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1), __webpack_require__(27)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, _, Backbone) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(25)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (sprintf) {
    return sprintf;
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
(function (global) {
    ...
    Splunk.util = {
            ...
            for (var i = 0; i < parts.length; i++) {
                ...
                if (output.hasOwnProperty(key)) {
                    if (Array.isArray(output[key])) {
                        ...
                        //Only create an array if it contains more than 1 choice.
                        var sampleKeys = [];
        ...
        getHash: function () {
            ...
            if (qPos != -1) return window.location.href.substr(qPos);
        ...
        getConfigValue: function (configKey, optionalDefault) {
            if (window.$C && window.$C.hasOwnProperty(configKey)) return window.$C[configKey];
                ...
                if (typeof optionalDefault != 'undefined') {
                    // ensure optionalDefault can be set to 'false'
        ...
        make_url: function () {
            ...
            if (output != '/') {
                ...
                if (firstseg == 'static' || firstseg == 'modules') {
                    ...
                    if (segments[2] == 'app') output += ':' + this.getConfigValue('APP_BUILD', 0);
                    output += '/' + postfix;
                }
            }
        ...
        validateCronString: function (cronString) {
            var cronRegEx =
                /^((0*([0-9]|[1-5][0-9])|\*)(-0*([0-9]|[1-5][0-9]))?(\/\d+)?,)*(0*([0-9]|[1-5][0-9])|\*)(-0*([0-9]|[1-5][0-9]))?(\/\d+)?\s((0*([0-9]|1[0-9]|2[0-3])|\*)(-0*([0-9]|1[0-9]|2[0-3]))?(\/\d+)?,)*(0*([0-9]|1[0-9]|2[0-3])|\*)(-0*([0-9]|1[0-9]|2[0-3]))?(\/\d+)?\s((0*([1-9]|[1-2][0-9]|3[0-1])|\*)(-0*([1-9]|[1-2][0-9]|3[0-1]))?(\/\d+)?,)*(0*([1-9]|[1-2][0-9]|3[0-1])|\*)(-0*([1-9]|[1-2][0-9]|3[0-1]))?(\/\d+)?\s((0*([1-9]|1[0-2])|\*)(-0*([1-9]|1[0-2]))?(\/\d+)?,)*(0*([1-9]|1[0-2])|\*)(-0*([1-9]|1[0-2]))?(\/\d+)?\s((0*[0-7]|\*)(-0*[0-7])?(\/\d+)?,)*(0*[0-7]|\*)(-0*[0-7])?(\/\d+)?$/;
        ...
        searchEscape: function (str, options) {
            if (!str.match(/[\s\,=|\[\]\"]/)) return options && options.forceQuotes ? '"' + str + '"' : str;
        ...
        getRetryInterval: function (elapsed_time, min_interval, max_interval, clamp_time) {
            ...
            return Math.min(
                max_interval * Math.pow(elapsed_time / parseFloat(clamp_time), 3) + min_interval,
                max_interval
            );
        },
        ...
        focusFirstField: function (popup) {
            //this puts the focus on the first form element whether an input or select dropdown
        ...
        restart_server: function (return_to) {
            ...
            var restart_check_status_img = function () {
                ...
                im.src =
                    restart_url_base + this.make_url('/config/img?proto=' + restart_url_proto + '&_=' + Math.random());
            ...
            $.post(
                this.make_url('/api/manager/control'),
    ...
    if (!String.prototype.rsplit) {
        String.prototype.rsplit = function (sep, limit) {
            ...
            if (limit && sp.length > limit) {
                var r = [];
                for (var i = 0; i < limit; i++) r[i] = sp[sp.length - limit + i];
                return r;
            }
            return sp;
        };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(12), __webpack_require__(24), __webpack_require__(0), __webpack_require__(15), __webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (
    Splunk,
    sprintf
) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(22), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    /*
...
// module
exports.push([module.i, "pre .str, code .str, pre .atv, code .atv { color: #D14; }\npre .kwd, code .kwd, .prettyprint .tag { color: #1e347b; }\npre .com, code .com { color: #93a1a1; font-style: italic; }\npre .typ, code .typ { color: teal; }\npre .lit, code .lit { color: #195f91; }\npre .pun, code .pun, pre .opn, code .opn, pre .clo, code .clo { color: #93a1a1; }\npre .pln, code .pln { color: #48484c; }\npre .typ, code .typ, pre .atn, code .atn, pre .dec, code .dec, pre .var, code .var { color: teal; }\npre .dec, code .dec { color: #3387CC; }\npre .fun, code .fun { color: #dc322f; }\n\n.prettyprint {\n    padding: 8px;\n    background-color: #f7f7f9;\n    border: 1px solid #e1e1e8;\n}\n.prettyprint.linenums {\n    -webkit-box-shadow: inset 40px 0 0 #fbfbfc, inset 41px 0 0 #ececf0;\n    -moz-box-shadow: inset 40px 0 0 #fbfbfc, inset 41px 0 0 #ececf0;\n    box-shadow: inset 40px 0 0 #fbfbfc, inset 41px 0 0 #ececf0;\n}\n\n/* Specify class=linenums on a pre to get line numbering */\nol.linenums {\n    margin: 0 0 0 33px; /* IE indents via margin-left */\n}\n.prettyprint ol.linenums li {\n    padding-left: 12px;\n    color: #bebec5;\n    line-height: 20px;\n    text-shadow: 0 1px 0 #fff;\n}\n\n/* Dark Theme */\n\npre.dark .str, code.dark .str { color: #65B042; }\npre.dark .kwd, code.dark .kwd { color: #E28964; }\npre.dark .com, code.dark .com { color: #AEAEAE; font-style: italic; }\npre.dark .typ, code.dark .typ { color: #89bdff; }\npre.dark .lit, code.dark .lit { color: #3387CC; }\npre.dark .pun, code.dark .pun { color: #FFFFFF; }\npre.dark .pln, code.dark .pln { color: #FFFFFF; }\npre.dark .tag, code.dark .tag { color: #BD9872; }\npre.dark .atn, code.dark .atn { color: #AF575A; }\npre.dark .atv, code.dark .atv { color: #58A383; }\npre.dark .dec, code.dark .dec { color: #3387CC; }\n\n.prettyprint.dark.linenums {\n    -webkit-box-shadow: inset 40px 0 0 #31373E, inset 41px 0 0 #2B3033;\n    -moz-box-shadow: inset 40px 0 0 #31373E, inset 41px 0 0 #2B3033;\n    box-shadow: inset 40px 0 0 #31373E, inset 41px 0 0 #2B3033;\n}\n\n.prettyprint.dark ol.linenums li {\n    text-shadow: none;\n}", ""]);
...
// EXTERNAL MODULE: ./splunkcore-web-ui/web_v2/search_mrsparkle/exposed/js/shim/jquery.js
var jquery = __webpack_require__(0);
var jquery_default = /*#__PURE__*/__webpack_require__.n(jquery);

// EXTERNAL MODULE: ./splunkcore-web-ui/web_v2/search_mrsparkle/exposed/js/require/underscore.js
var underscore = __webpack_require__(1);
var underscore_default = /*#__PURE__*/__webpack_require__.n(underscore);

// EXTERNAL MODULE: ./splunkcore-web-ui/web_v2/search_mrsparkle/exposed/js/shim/splunk.util.js
var splunk_util = __webpack_require__(3);
var splunk_util_default = /*#__PURE__*/__webpack_require__.n(splunk_util);

// EXTERNAL MODULE: ./splunkcore-web-ui/web_v2/search_mrsparkle/exposed/js/require/backbone.js
var backbone = __webpack_require__(2);
var backbone_default = /*#__PURE__*/__webpack_require__.n(backbone);

// CONCATENATED MODULE: ./simple_xml_examples/appserver/static/contrib/showdown.js
//
...
//
	...
	// Build a regex to find HTML tags and comments.
	var regex = /(<[a-z\/!$]("[^"]*"|'[^']*'|[^'">])*>|<!(--.*?--\s*)+>)/gi;
...
/* harmony default export */ var showdown = (Showdown);

// EXTERNAL MODULE: ./simple_xml_examples/appserver/static/contrib/prettify.js
var prettify = __webpack_require__(92);

// CONCATENATED MODULE: ./simple_xml_examples/appserver/static/shims/esm/prettify.js
// ESM module that exposes an exported function from Google's prettify that defines a window prettyPrint function


/* harmony default export */ var esm_prettify = (window.prettyPrint);
// EXTERNAL MODULE: ./simple_xml_examples/appserver/static/theme_utils.js
var theme_utils = __webpack_require__(11);
var theme_utils_default = /*#__PURE__*/__webpack_require__.n(theme_utils);

// EXTERNAL MODULE: ./simple_xml_examples/appserver/static/code_theme.css
var code_theme = __webpack_require__(93);

// CONCATENATED MODULE: ./simple_xml_examples/appserver/static/components/srcviewer/codeview.js
...
var codeview_isDarkTheme = theme_utils_default.a.getCurrentTheme() === 'dark';

var CodeView = backbone_default.a.View.extend({
    options: {
        stripI18n: true
    },
    initialize: function() {
    ...
    render: function() {
        this.$el.html(this.template({
            ...
            isDarkTheme: codeview_isDarkTheme
        }));
        this.$el.attr({ 'class': 'tab-pane', 'id': this.model.get('id') });
        esm_prettify(function() {}, this.el);
        return this;
    },
    template: underscore_default.a.template(
...
/* harmony default export */ var codeview = (CodeView);
// CONCATENATED MODULE: ./simple_xml_examples/appserver/static/contrib/bootstrap-tab.js
// From splcore/web_v2/search_mrsparkle/exposed/js/contrib/bootstrap-2.3.1/bootstrap-tab.js
// This was pulled out of core because their version uses the window's jQuery
...
, show: function () {
    ...
    $target = jquery_default()(selector)
...
, activate: function ( element, container, callback) {
    var $active = container.find('> .active')
      , transition = callback
          && jquery_default.a.support.transition
    ...
    transition ?
      $active.one(jquery_default.a.support.transition.end, next) :
      next()
...
var old = jquery_default.a.fn.tab

jquery_default.a.fn.tab = function ( option ) {
  return this.each(function () {
...
jquery_default.a.fn.tab.Constructor = Tab


/* TAB NO CONFLICT
 * =============== */

jquery_default.a.fn.tab.noConflict = function () {
  jquery_default.a.fn.tab = old
  return this
}
...
jquery_default()(document).on('click.tab.data-api', '[data-toggle="tab"], [data-toggle="pill"]', function (e) {
  e.preventDefault()
  jquery_default()(this).tab('show')
})

// EXTERNAL MODULE: ./simple_xml_examples/appserver/static/components/srcviewer/thirdpartyLibraryNotice.md
var thirdpartyLibraryNotice = __webpack_require__(54);
var thirdpartyLibraryNotice_default = /*#__PURE__*/__webpack_require__.n(thirdpartyLibraryNotice);

// CONCATENATED MODULE: ./simple_xml_examples/appserver/static/components/srcviewer/srcviewer.js
...
var srcviewer_markdown = new showdown.converter();

var srcviewer_isDarkTheme = theme_utils_default.a.getCurrentTheme() === 'dark';

var SourceCodeViewer = backbone_default.a.View.extend({
    className: srcviewer_isDarkTheme ? 'sourcecode-viewer dark' : 'sourcecode-viewer',
    options: {
    ...
    events: {
        'click .nav>li>a': function(e) {
            e.preventDefault();
            jquery_default()(e.currentTarget).tab('show');
        }
    },
    addItem: function(model) {
        if (!model.has('id')) {
            model.set('id', underscore_default.a.uniqueId('tab_'));
        }
        var id = model.get('id');
        var filename = model.get('name');
        var fileUrl = model.get('url') || '';
        var link = jquery_default()('<a class="tab-title-text"></a>').text(filename).attr('href', fileUrl + '#' + id);
        var li = jquery_default()('<li></li>').append(link);
        this.$('.nav-tabs').append(li);

        var item = new codeview({
            model: model,
            el: jquery_default()('<div></div>').appendTo(this.$('.tab-content'))
        });
        item.render();
    ...
    render: function() {
        underscore_default()(this.items).invoke('remove');
        this.items.length = 0; // Clear items array

        var model = underscore_default.a.extend({
            _: underscore_default.a,
            description: '',
            shortDescription: '',
            related_links: null,
            showsource_container: srcviewer_isDarkTheme ? 'showsource-container dark' : 'showsource-container'
        ...
        if (model.description) {
            if (this.collection.some(function(sourceFileModel) {
                ...
                model.description = model.description + "\n<hr>\n" + thirdpartyLibraryNotice_default.a.replace(
                    new RegExp('/static/app/simple_xml_examples/\\S+', 'g'),
                    function(url) { return splunk_util_default.a.make_url(url); }
                );
            }
            model.description = srcviewer_markdown.makeHtml(model.description);
        }

        this.$el.addClass(this.className);
        this.$el.html(this.template(model));
        this.collection.map(underscore_default()(this.addItem).bind(this));
...
/* harmony default export */ var srcviewer = (SourceCodeViewer);
// CONCATENATED MODULE: ./webpack-loaders/public-path-loader.js!./simple_xml_examples/appserver/static/dashboard.js
__webpack_require__.p = window.location.pathname.replace(/app\/simple_xml_examples.*/, `static/@${__splunkd_partials__["/services/server/info"].entry[0].content.build}-${__splunkd_partials__["/servicesNS/nobody/system/apps/local/simple_xml_examples"].entry[0].content.build}/app/simple_xml_examples/build`);
...
requirejs([
    ...
    jquery_default()('body').off('.data-api');
    // Open external links in new window
    jquery_default()('.external[href]').bind('click', function(e) {
        e.preventDefault();
        window.open(jquery_default()(e.currentTarget).attr('href'));
    });

    var APP = 'simple_xml_examples';

    var exampleInfoCollection = new backbone_default.a.Collection();
    var exampleInfoLoaded = exampleInfoCollection.fetch({
        url: splunk_util_default.a.make_url('/static/app/' + APP + '/exampleInfo.json'),
        cache: true
    });

    var isDarkTheme = theme_utils_default.a.getCurrentTheme() === 'dark';
    ...
    DashboardController.onReady(function() {
        DashboardController.onViewModelLoad(function() {
            ...
            if (splunk_util_default.a.normalizeBoolean(root.attr('showsource')) === false) {
                return;
            }

            jquery_default.a.when(exampleInfoLoaded).then(function() {

                var model = exampleInfoCollection.get(view.entry.get('name'));
                if (!model) {
                    model = new backbone_default.a.Model({
                        shortDescription: '',
                        description: '',
                        related_links: []
                    });
                ...
                if (model.has('related_links')) {
                    var translatedLinks = underscore_default()(model.get('related_links')).map(function(link) {
                        var label = link;
                ...
                if (model.has('description-url') || !model.has('description')) {
                    ...
                    jquery_default.a.ajax({
                        url: splunk_util_default.a.make_url(url),
                        dataType: 'text',
                ...
                var sourceFileModels = new backbone_default.a.Collection();
                ...
                if (customScripts) {
                    underscore_default()(customScripts.split(',')).chain().map(jquery_default.a.trim).each(function(script) {
                        var codeModel = new backbone_default.a.Model({
                            name: script,
                            url: '/static/app/' + APP + '/docs/' + script
                        });
                        sourceFileModels.add(codeModel);
                        jquery_default.a.ajax({
                            url: splunk_util_default.a.make_url('/static/app/' + APP + '/docs/' + script),
                            dataType: 'text',
                ...
                if (customStylesheets) {
                    underscore_default()(customStylesheets.split(',')).chain().map(jquery_default.a.trim).each(function(stylesheet) {
                        var codeModel = new backbone_default.a.Model({
                            name: stylesheet,
                        ...
                        sourceFileModels.add(codeModel);
                        jquery_default.a.ajax({
                            url: splunk_util_default.a.make_url('/static/app/' + APP + '/' + stylesheet),
                            dataType: 'text',
                            success: function(source) {
                                codeModel.set('content', source);
                            },
                ...
                if (model.has('banner')) {
                    ...
                    jquery_default.a.ajax({
                        ...
                        success: function(text) {
                            ...
                            var banner = jquery_default()(underscore_default.a.template(bannerTemplate, { message: markdown.makeHtml(text) }));
                            if (isDarkTheme) {
                                banner.addClass('dark');
                            }
                            jquery_default()('.main-section-body.dashboard-body').prepend(jquery_default()(banner));
                        }
                    });
                }
                ...
                if (model.has('sourceFiles')) {
                    underscore_default()(model.get('sourceFiles')).each(function(link) {
                        ...
                        sourceFileModels.add(codeModel);
                        jquery_default.a.ajax({
                            url: splunk_util_default.a.make_url(link),
                            dataType: 'text',
                            success: function(source) {
                                codeModel.set('content', source);
                            },
                ...
                var footer = jquery_default()('#footer');
                var SourceViewerEl = jquery_default()('<div/>');
                if (footer.length > 0) {
                    SourceViewerEl.insertBefore(footer);
                } else {
                    SourceViewerEl.appendTo(jquery_default()('body'));
                }
                ...
                jquery_default()('.main-section-body.dashboard-body').css('min-height', '100px');
            });
        });
    });
});
