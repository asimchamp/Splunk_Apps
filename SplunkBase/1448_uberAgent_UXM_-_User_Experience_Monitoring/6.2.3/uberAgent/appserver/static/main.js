...
DashboardFilters.prototype.ConfigureLevelOneFilters = function ()
{
   ...
   [
      ...
      {value: "sTagsHost", label: "Host tags"}
   ];
   ...
   if (filterDatamodel == "Application_BrowserPerformanceChrome")
   {
      choices.push
      (
         {value: "sProcType", label: "Process type"},
         {value: "sProcUser", label: "User name"},
   ...
   else if (filterDatamodel == "Application_BrowserWebRequests2")
   {
      ...
      (
         ...
         {value: "sBrowserVersion", label: "Browser version"},
         {value: "nWebRequestDurationMs", label: "Browser web request duration (ms)"},
         {value: "nPageLoadTotalDurationMs", label: "Browser page load - total duration (ms)"},
         {value: "nPageLoadNetworkDurationMs", label: "Browser page load - network duration (ms)"},
         {value: "nPageLoadRenderDurationMs", label: "Browser page load - render duration (ms)"},
         {value: "nHttpStatusCount2xx", label: "HTTP 2xx status count"},
         {value: "nHttpStatusCount3xx", label: "HTTP 3xx status count"},
         {value: "nHttpStatusCount4xx", label: "HTTP 4xx status count"},
         {value: "nHttpStatusCount5xx", label: "HTTP 5xx status count"},
         {value: "sIsFrame", label: "Browser: is subframe? [0|1]"},
         {value: "sRequestHost", label: "Request target URL"},
         {value: "sRequestTypeDisplayName", label: "Request type"},
         {value: "sRequestUriSchemeDisplayName", label: "Request URI scheme (e.g. https)"},
         {value: "sTabHost", label: "Tab URL"},
         {value: "sTabUriSchemeDisplayName", label: "Tab URI scheme (e.g. https)"},
         {value: "sUser", label: "User"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   else if (filterDatamodel == "Application_Errors")
   {
      choices.push
      (
         {value: "sAppName", label: "Application name"},
         {value: "sErrorTypeName", label: "Error type"},
         {value: "sExceptionCode", label: "Exception code"},
         {value: "sModuleName", label: "Faulting module name"},
         {value: "sModuleVersion", label: "Faulting module version"},
         {value: "nProcID", label: "Process ID"},
         {value: "sProcName", label: "Process name"},
         {value: "sProcVersion", label: "Process version"},
         {value: "sUser", label: "User"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   else if (filterDatamodel == "Application_ApplicationInventory")
   {
      choices.push
      (
         {value: "sDisplayName", label: "App name"},
         {value: "sDisplayVersion", label: "App version"},
         {value: "sInstallLocation", label: "Install location"},
         {value: "sLanguage", label: "Language"},
         {value: "sPublisher", label: "Publisher"}
      );
   }
   else if (filterDatamodel == "Application_NetworkConnectFailure")
   {
      ...
      (
         {value: "sAppName", label: "Application name"},
         {value: "sAppVersion", label: "Application version"},
         {value: "sNetTargetProtocols", label: "Protocols"},
         {value: "sNetTargetRemoteAddress", label: "Target address"},
         {value: "sNetTargetRemoteName", label: "Target name"},
         {value: "sNetTargetRemoteNameAddress", label: "Target name or address"},
         {value: "nNetTargetRemotePort", label: "Port"},
         {value: "sProcessName", label: "Process name"},
         {value: "sUser", label: "User"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   ...
   else if (filterDatamodel == "Application_UIDelay")
   {
      ...
      (
         {value: "sAppName", label: "Application name"},
         {value: "sAppVersion", label: "Application version"},
         {value: "nProcessId", label: "Process ID"},
         {value: "sProcessName", label: "Process name"},
         {value: "sUser", label: "User"},
         {value: "sTagsUser", label: "User tags"}
      );
   ...
   else if (filterDatamodel == "Application_SoftwareUpdateInventory")
   {
      ...
      (
         {value: "sDisplayName", label: "App name"},
         {value: "sGuid", label: "GUID"},
         {value: "sInstallDate", label: "Install date"},
         {value: "sProductName", label: "Product name"},
         {value: "sState", label: "State"}
      );
   }
   ...
   else if (filterDatamodel == "CommonWithUserAppName")
   {
      ...
      choices.push
      (
         {value: "sAppName", label: "App name"},
         {value: "sAppVersion", label: "App version"},
         {value: "sUser", label: "User name"}
      );
   }
   else if (filterDatamodel == "License_LicenseInfo")
   {
      choices.push
      (
         {value: "sExpiration", label: "Expiration"},
         {value: "sLicensedComponents", label: "Licensed components"},
         {value: "sLicenseId", label: "License ID"},
         {value: "sLicensingModel", label: "Licensing model"},
         {value: "sLicensingModelDetail", label: "Licensing model detail"},
         {value: "sLicensingState", label: "Licensing state"},
         {value: "sLicensingType", label: "Licensing type"},
         {value: "sMaintenanceEnd", label: "Maintenance end"},
         {value: "sProductVersion", label: "Product version"}
      );
   }
   ...
   else if (filterDatamodel == "Logon_LogonDetail")
   {
      choices.push
      (
         {value: "sLogonServer", label: "Logon server"},
         {value: "sLoopbackMode", label: "Loopback mode"},
         {value: "sUser", label: "User name"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   ...
   else if (filterDatamodel == "OnOffTransition_SlowShutdown")
   {
      choices.push
      (
         {value: "sFriendlyName", label: "Display name"},
         {value: "sName", label: "Name"},
         {value: "sVersion", label: "Version"}
      );
   }
   else if (filterDatamodel == "OnOffTransition_SlowStandbyResume")
   {
      choices.push
      (
         {value: "sDeviceFriendlyName", label: "Device display name"},
         {value: "sFriendlyName", label: "Display name"},
         {value: "sName", label: "Name"},
         {value: "sVersion", label: "Version"}
      );
   ...
   else if (filterDatamodel == "OnOffTransition_StandbyDetail")
   {
      choices.push
      (
         {value: "nEffectiveState", label: "Effective state"},
         {value: "sWakeSourceTypeDisplayName", label: "Wake source type"}
      );
   }
   else if (filterDatamodel == "Process_NetworkTargetPerformance")
   {
      ...
      (
         ...
         {value: "sProcName", label: "Process name"},
         {value: "sNetTargetProtocols", label: "Protocols"},
         {value: "sNetTargetRemoteNameAddressPort", label: "Target"},
         {value: "sProcUser", label: "User name"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   ...
   else if (filterDatamodel == "Session_SessionDetail_Users")
   {
      choices.push
      (
         {value: "sSessionBrokerType", label: "Broker type"},
         {value: "sSessionAppStateCtx", label: "Citrix app state"},
         {value: "sSessionPublishedAppsCtx", label: "Citrix published apps in use"},
         {value: "sSessionClientIp", label: "Client IP"},
         {value: "sSessionClientMac", label: "Client MAC"},
         {value: "sSessionClientName", label: "Client name"},
         {value: "sSessionClientPlatform", label: "Client platform"},
         {value: "sSessionClientVersion", label: "Client version"},
         {value: "sSessionConnectionState", label: "Connection state"},
         {value: "sSessionProtocol", label: "Remoting protocol"},
         {value: "sSessionGUID", label: "Session GUID"},
         {value: "sSessionUser", label: "Session user"},
         {value: "sSessionBrokerDnsVmw", label: "VMware broker DNS name"},
         {value: "sSessionBrokerRemoteIpVmw", label: "VMware broker remote IP"},
         {value: "sSessionBrokerTunnelUrlVmw", label: "VMware broker tunnel URL"},
         {value: "sSessionBrokerUrlVmw", label: "VMware broker URL"},
         {value: "sTagsUser", label: "User tags"}
      );
   }
   ...
   else if (filterDatamodel == "System_Bugcheck")
   {
      choices.push
      (
         {value: "sBugcheckCodeDisplayName", label: "Stop error"}
      );
   }
   else if (filterDatamodel == "System_MachineInventory")
   {
      choices.push
      (
         {value: "sHwBiosVersion", label: "BIOS version"},
         {value: "sOsName", label: "OS name"},
         {value: "sOsSpName", label: "OS service pack"}
      );
   }
   else if (filterDatamodel == "System_SmbClient")
   {
      choices.push
      (
         {value: "sSharePath", label: "Network share (UNC)"}
      );
   }
