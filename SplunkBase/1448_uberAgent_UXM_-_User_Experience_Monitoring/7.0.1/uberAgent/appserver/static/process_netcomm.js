         ...
         "splunkjs/mvc/tokenforwarder"], function (mvc)
{
   ...
   if (mode == "app")
   {
      ...
      document.title = document.title.replace (regex, gettext("Application Network Communication "));
      if (easySplunkVersion >= 70300)
      {
         $('.dashboard-header > h1').text (gettext("Application Network Communication"));
      }
      else
      {
         $('.dashboard-header > h2').text (gettext("Application Network Communication"));
      }
   }
   else if (mode == "proc")
   {
      ...
      // Page title and description
      document.title = document.title.replace (regex, gettext("Process Network Communication "));
      if (easySplunkVersion >= 70300)
      {
         $('.dashboard-header > h1').text (gettext("Process Network Communication"));
      }
      else
      {
         $('.dashboard-header > h2').text (gettext("Process Network Communication"));
      }
   ...
   else
   {
      ...
      // Page title and description
      document.title = document.title.replace (regex, gettext("Machine Network Communication "));
      if (easySplunkVersion >= 70300)
      {
         $('.dashboard-header > h1').text (gettext("Machine Network Communication"));
      }
      else
      {
         $('.dashboard-header > h2').text (gettext("Machine Network Communication"));
      }
   }   
