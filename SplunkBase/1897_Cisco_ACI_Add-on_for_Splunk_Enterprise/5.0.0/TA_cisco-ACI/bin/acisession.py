...
class Session(object):
    ...
    """
    def __init__(self, url, uid, pwd=None, cert_name=None, key=None, verify_ssl=True,
        ...
        if key and cert_name:
            if NO_RSA:
                raise ImportError('Cannot use certificate authentication because rsa is not available.\n\
            ...
            try:
                ...
                logging.error('Make sure that you had converted your key to RSA private key. if not, follow the steps given in setup guide for the same.')
