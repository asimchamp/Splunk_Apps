...
(function () {
    ...
    txt += "		  <div class='divIronstreamDashboardHelpBody'><iframe class='syncsort-ironstream-help-frame' src='/static/app/" + pth + "/Syncsort_Ironstream_MQ_Monitor_Help.html' name=targetframe' allowTransparency='true' frameborder='0' scrolling='yes'></iframe></div>";
    txt += "	    </div>";
