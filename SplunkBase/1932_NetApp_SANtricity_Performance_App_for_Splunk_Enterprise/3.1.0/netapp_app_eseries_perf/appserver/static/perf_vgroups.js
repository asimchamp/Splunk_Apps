...
require([
    ...
    var update_breadcrumb_href = function() {
        ...
        var newHref = "/app/netapp_app_eseries_perf/perf_array?form.arrayId=" + newArrayId;
        $('#perf_vgroups_breadcrumb').attr('href', newHref);
    };
    ...
    var update_configuration_href = function() {
        ...
        $('#perf_vgroups_configuration').attr('href', newHref);
    };
