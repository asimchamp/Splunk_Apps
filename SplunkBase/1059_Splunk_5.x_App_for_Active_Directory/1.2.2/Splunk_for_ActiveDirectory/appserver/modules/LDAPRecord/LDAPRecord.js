/**
 * Module Javascript for LDAPRecord
 * Copyright (C) 2012 Splunk, Inc.
 * All Rights Reserved
 */
Splunk.Module.LDAPRecord = $.klass(Splunk.Module.DispatchingModule, {
	...
	initialize: function($super, container) {
		...
		$super(container);
		this._container = $('#'+container.id + '> #LDAPRecordWrapper');
	},
	...
	/**
	 * Event handler for handling when the upstream search is complte
	 */
	...
	buildOC: function(oc, ldapRecord) {
		// MAIN BLOCK
		var block = $('<div class="oc" id="'+oc+'"><h3 class="title">'+oc+'</h3><div class="content"></div></div>').appendTo(this._container);
