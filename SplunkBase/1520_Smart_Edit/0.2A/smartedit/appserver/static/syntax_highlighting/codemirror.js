...
var CodeMirror = (function(){
  ...
  function frameHTML(options) {
    ...
    // SPLUNK - i have to add in the i18n file, and its on a completely different path so im 
    // hardwiring it here.  If we dont then we get exceptions when gareth stitches in 
    // calls to i18n_register() into our static files 
    var i18n_path = Splunk.util.make_url("static", "js", "i18n.js")
    html.push("<script type=\"text/javascript\" src=\"" + i18n_path + "\"><" + "/script>");
    forEach(options.basefiles.concat(options.parserfile), function(file) {
      // SPLUNK - had to add a slash between the path and file, cause our make-url will never return a path 
