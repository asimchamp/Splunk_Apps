...
class IOCDisplayCommand(GeneratingCommand):
    indicator_raw_id = Option(name='indicator_raw_id', require=False)
    indicator_id = Option(name='indicator_id', require=False)
    ioc_id = Option(name='ioc_id', require=False)
    raw_id = Option(name='raw_id', require=False)
