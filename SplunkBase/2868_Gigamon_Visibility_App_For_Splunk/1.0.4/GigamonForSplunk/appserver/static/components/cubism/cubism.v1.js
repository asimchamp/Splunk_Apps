...
cubism_contextPrototype.horizon = function() {
  console.log("starting prototype horizon");
  var context = this,
      mode = "offset",
  ...
  function horizon(selection) {
	...
	console.log("change");
	    ...
	    console.log("setting scale 3");
          ...
          for (var j = 0; j < m; ++j) {
            ...
            // Adjust the range based on the current band index.
            var y0 = (j - m + 1) * height;
	    console.log("setting scale 4");
	    console.log("m: "+m+" height:"+height+" y0:"+y0);
            scale.range([m * height + y0, y0]);
            y0 = scale(0);
      ...
      function focus(i) {
        ...
        //console.log(span.datum(value));
        //span.datum(value).text(value);
      }
	...
	console.log("change horizon start: "+start+" stop: "+stop);
