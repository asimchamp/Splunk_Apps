...
require.config({
    paths: {
        'waypoints': '../app/cisco-app-ACI/contrib/waypoints',
        'waypoints-sticky': '../app/cisco-app-ACI/contrib/waypoints-sticky'
    },
...
require(['jquery', 'underscore', 'waypoints', 'waypoints-sticky'], function($, _, waypoint, waypointsSticky) {
    ...
    $(function(){
        ...
        // taken from: https://stackoverflow.com/questions/7717527/jquery-smooth-scrolling-when-clicking-an-anchor-link
        $('a').click(function(){
            $('html, body').animate({
        ...
        var staticUrl = '../../../en-US/static/app/cisco-app-ACI/';
