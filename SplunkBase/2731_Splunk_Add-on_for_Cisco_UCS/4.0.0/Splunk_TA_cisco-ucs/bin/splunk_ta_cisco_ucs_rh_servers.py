...
fields = [
    field.RestField(
        ...
        encrypted=False,
        default=None,
        validator=validator.String(max_len=255, min_len=0,),
    ),
    field.RestField(
        "server_url",
        required=True,
        ...
        validator=validator.AllOf(
            validator.Pattern(regex=r"""^[a-zA-Z0-9:][a-zA-Z0-9\.\-:]+$""",),
            validator.String(max_len=4096, min_len=0,),
        ),
    ),
    field.RestField(
        "account_name",
        ...
        encrypted=False,
        default=None,
        validator=validator.String(max_len=255, min_len=1,),
    ),
    field.RestField(
        "account_password",
        required=True,
...
if __name__ == "__main__":
    ...
    admin_external.handle(
        endpoint, handler=CiscoUCSServerHandler,
    )
