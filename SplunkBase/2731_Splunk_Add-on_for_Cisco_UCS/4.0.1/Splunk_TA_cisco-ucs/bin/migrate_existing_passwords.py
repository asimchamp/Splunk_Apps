...
class MigrateExistingPasswords:
    ...
    def update_server_conf(self, session_key, creds_list):
        ...
        try:
            ...
            logger.error(
                "Exception occured while getting servers_conf object. {} ".format(
    ...
    def get_credentials(self, session_key):
        ...
        try:
            ...
            logger.error(
                "error while retrieveing server details from the cisco_ucs_servers.conf. {} ".format(
                    traceback.format_exc()
                )
            )
    ...
    def migrate_existing_passwords(self):
        ...
        try:
            ...
            logger.error(
                "Error while migrating passwords. {} ".format(traceback.format_exc())
            )
