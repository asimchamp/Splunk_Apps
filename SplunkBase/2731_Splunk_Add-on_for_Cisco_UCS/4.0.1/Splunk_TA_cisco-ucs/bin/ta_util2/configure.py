...
def get_modinput_configs(modinput, modinput_stanza=None):
    ...
    ).communicate()  # nosemgrep false-positive: The vulnerable method get_modinput_configs in the ta_util2 framework file is not getting used anywhere in the add-on v3.1.0.
    if err:
