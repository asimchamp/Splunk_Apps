	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports, module) {
	    ...
	    return VisualizationBase.extend({
	        ...
	        formatData: function() {
	            ...
	            if ((this._layerType === "marker") && this._markerLayer) {
	                ...
	                if (filteredFields && filteredFields.length > 1) {
	                    ...
	                    this.model.config.set({ autoDetectedColorMode: this._choroplethAutoDetectedColorMode });
	        ...
	        remove: function() {
	            ...
	            this._map.dispose();
	            this._markerLayer.off("rendered", this._onViewUpdated, this);
	            this._choroplethLayer.off("rendered", this._onViewUpdated, this);
	            ...
	            switch (propertyName) {
	                ...
	                case "type":
	                    if (propertyValue === "marker") {
	                        ...
	                        this._markerLayer.on("rendered", this._onViewUpdated, this);
	                        ...
	                        this._choroplethLayer.on("rendered", this._onViewUpdated, this);
	                        this._updateChoroplethToMatchColorMode();
	                        this._updateDataParams();
	                    } else {
	    ...
	    return Class(module.id, VizBase, function(Map, base) {
	        ...
	        var LeafletTooltip = Leaflet.Popup.extend({
	            ...
	            _updatePosition: function() {
	                ...
	                var tooltipLeft = centerPoint.x - (tooltipWidth / 2);
	                var tooltipRight = centerPoint.x + (tooltipWidth / 2);
	                var tooltipTop = centerPoint.y - (tooltipHeight / 2);
	                var tooltipBottom = centerPoint.y + (tooltipHeight / 2);
	                var offsetX = 0;
	                var offsetY = 0;

	                if (tooltipLeft < mapLeft) {
	                    offsetX = mapLeft - tooltipLeft + (tooltipWidth / 2) + this.options.paddingX;
	                }
	                if (tooltipRight > mapRight) {
	                    offsetX = mapRight - tooltipRight - (tooltipWidth / 2) - this.options.paddingX;
	                }
	                if (tooltipTop < mapTop) {
	                    offsetY = mapTop - tooltipTop + (tooltipHeight / 2) + this.options.paddingY;
	                }
	                if (tooltipBottom > mapBottom) {
	                    offsetY = mapBottom - tooltipBottom - (tooltipHeight / 2) - this.options.paddingY;
	                }

	                if (is3d) {
	                    Leaflet.DomUtil.setPosition(tooltip, centerPoint);
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("contrib/leaflet/leaflet.css"),
	       __webpack_require__("../../../node_modules/imports-loader/index.js?this=>window!./contrib/leaflet/leaflet")], __WEBPACK_AMD_DEFINE_RESULT__ = function(css, leaflet) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__("../../../node_modules/css-loader/index.js!./contrib/leaflet/leaflet.css");
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__("../../../node_modules/style-loader/addStyles")(content, {});
...
/***/ "../../../node_modules/css-loader/index.js!./contrib/leaflet/leaflet.css":
/***/ function(module, exports, __webpack_require__) {

	exports = module.exports = __webpack_require__("../../../node_modules/css-loader/lib/css-base")();
	// imports
...
/***/ "../../../node_modules/imports-loader/index.js?this=>window!./contrib/leaflet/leaflet":
/***/ function(module, exports) {
	    ...
	    return Class(module.id, VectorLayerBase, function(ChoroplethLayer, base) {
	        ...
	        this.renderOverride = function(map) {
	            ...
	            for (var i = 0, l = polygonList.length; i < l; i++) {
	                ...
	                polygon.tooltipOffsetRadius = Math.ceil(polygonPixelBounds.width / 2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__("../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/postcss-loader/index.js!./views/shared/map/Master.pcss");
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__("../../../node_modules/style-loader/addStyles")(content, {});
	if(content.locals) module.exports = content.locals;
...
/***/ "../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/postcss-loader/index.js!./views/shared/map/Master.pcss":
/***/ function(module, exports, __webpack_require__) {
