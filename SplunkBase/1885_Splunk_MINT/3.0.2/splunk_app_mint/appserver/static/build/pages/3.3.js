	        ...
	        return VisualizationBase.extend({
	            ...
	            updateResultState: function() {
	                ...
	                if (this.isTimeSeries() && !isNaN(resultFieldValue)) {
	                    ...
	                    this.model.config.set('is_timeseries', true);
	                } else {
	                    ...
	                    this.model.config.set('is_timeseries', false);
	                }
	            ...
	            getSeverityColor: function(resultFieldValue) {
	                ...
	                if (ranges) {
	                    ...
	                    useColors = parsedColors.length > 0;
	                ...
	                } else if (rangeMapValue) {
	                    // If the classField is range and the range field contains is a valid severity, use this as the severity
	            ...
	            useColors: function() {
	                var useColors = splunkUtil.normalizeBoolean(this.model.config.get('display.visualizations.singlevalue.useColors')) || false, // default to false
	                    ranges = this.model.config.get('display.visualizations.singlevalue.rangeValues'),
	                    rangeMapValue = this.getFieldValues('range');
	                // Default to use old Rangemap command result
	                if (!ranges && rangeMapValue) {
	                    return true;
	                }
	                return useColors;
	            },
	            ...
	            updateView: function() {
	                ...
	                if(this.model.searchDataParams) {
	                    maxResultCount = this.model.searchDataParams.get('count');
	                }
	                if(this.model.results.get('sparkline') && this.model.results.get('sparkline').length >= maxResultCount) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("../../../node_modules/imports-loader/index.js?this=>window!./contrib/numeral")], __WEBPACK_AMD_DEFINE_RESULT__ = function(numeral) {
...
/***/ "../../../node_modules/imports-loader/index.js?this=>window!./contrib/numeral":
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("util/moment"), __webpack_require__("require/underscore")], __WEBPACK_AMD_DEFINE_RESULT__ = function(moment, _) {
