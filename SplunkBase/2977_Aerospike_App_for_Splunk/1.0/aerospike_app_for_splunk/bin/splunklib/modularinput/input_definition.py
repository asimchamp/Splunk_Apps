...
class InputDefinition:
    ...
    def parse(stream):
        ...
        return definition
	"""
	for each_line in fileinput.input("Employee.csv"):
	    words = each_line.split(",")
	    count=0;
	    definition.inputs=words[0]
	    tags={"empname","empno","mobile","email","project","practce"}
	    while count != len(words):			    
		definition.metadata[tags[count]] = words[count]
		count=count+1;
	return definition"""
