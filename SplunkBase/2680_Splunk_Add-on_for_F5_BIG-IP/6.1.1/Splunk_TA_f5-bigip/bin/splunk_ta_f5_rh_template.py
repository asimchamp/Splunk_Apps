...
logger = setup_logging("splunk_ta_f5_rh_template")
...
class F5TemplateHandler(AdminExternalHandler):
    ...
    def handle_request(self, conf_info, is_handle_edit_operation):
        ...
        try:
            ...
            logger.error("Error occured while listing the templates: " + str(e))
    ...
    def handleRemove(self, confInfo):
        ...
        logger.info("Successfully deleted the template: {}".format(self.callerArgs.id))
