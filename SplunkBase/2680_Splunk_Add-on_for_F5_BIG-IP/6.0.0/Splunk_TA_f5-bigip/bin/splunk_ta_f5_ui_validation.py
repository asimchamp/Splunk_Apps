...
logger = setup_logging("splunk_ta_f5_server_validation")
    ...
    def validate(self, value, data):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                msg = "Authorization failed. Please verify the correct credentials are provided"
                self.put_msg(msg)
                return False
    ...
    def validate(self, value, data):
        if data.get("hec_name"):
            ...
            try:
                ...
                logger.error(
                    "Exception occured while validating hec token: {}".format(e)
                )
