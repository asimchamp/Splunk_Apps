...
logger = setup_logging("splunk_ta_checkpoint_key_removal")
...
class CheckpointKeyRemove:
    ...
    def data_collection_state_remove(self):
        session_key = common_utility.get_session_key()
        ...
        if inputs_list:
            ...
            for input_name in inputs_list:
                checkpoint_object = Checkpointer(session_key, {})
                    ...
                    if checkpoint_value.get("data_collection_state"):
                        ...
                        try:
                            ...
                            common_utility.checkpoint_handler(
                                session_key, input_name, str(encode_value)
                            )
                            logger.info(
