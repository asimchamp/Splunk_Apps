...
def process_event(helper, *args, **kwargs):
    ...
    zentith_ar_host_ip = helper.get_param("zentith_ar_host_ip")
    helper.log_info("zentith_ar_host_ip={}".format(zentith_ar_host_ip))
    ...
    """
    helper.log_info("Alert action Zenith Stop SMBv1 Service.")
        
    extension_name = "Stops SMBv1 Service"
    agent_guid = ""
    extension_id = ""
