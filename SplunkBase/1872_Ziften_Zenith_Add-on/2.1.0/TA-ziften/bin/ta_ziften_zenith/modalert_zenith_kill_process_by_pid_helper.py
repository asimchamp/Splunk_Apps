...
def process_event(helper, *args, **kwargs):
    ...
    helper.log_info("Alert action Zenith Kill Process by PID started.")
    print "START"
    ...
    if extension_id == "" :
        helper.log_info("Zenith Quarantine Host action not found.")
        exit(-1)
    ...
    if extension_id == "" :
        helper.log_info("Zenith Quarantine Host computername not found.")
        exit(-1)
