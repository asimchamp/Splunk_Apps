        ...
        while 1:
            ...
            if event is not None:
                try:
                    ...
                    _LOGGER.critical("Events are not getting ingested. Possible cause could be mismatch of event character set with system defined character set. Error message : %s", e)
                flush()
            else:
                break
