...
class KVClient:
    ...
    def create_collection(self, collection, app, owner="nobody"):
        ...
        assert collection  # nosemgrep: gitlab.bandit.B101
        assert app  # nosemgrep: gitlab.bandit.B101
    ...
    def insert_collection_data(self, collection, data, app, owner="nobody"):
        ...
        assert collection  # nosemgrep: gitlab.bandit.B101
        assert data is not None  # nosemgrep: gitlab.bandit.B101
        assert app  # nosemgrep: gitlab.bandit.B101
    ...
    def update_collection_data(self, collection, key_id, data, app, owner="nobody"):
        ...
        assert collection  # nosemgrep: gitlab.bandit.B101
        assert key_id  # nosemgrep: gitlab.bandit.B101
        assert app  # nosemgrep: gitlab.bandit.B101
    ...
    def _do_request(
        ...
        elif resp.status_code in (500, 404):
