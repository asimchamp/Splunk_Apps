require([
    ...
    $.ajax({
        type: "GET",
        url: "../../../../en-US/splunkd/__raw/services/commandmodinput/commandmodinputsetup/commandmodinput?output_mode=json",
    ...
    $(submit_button).click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../../../en-US/splunkd/__raw/services/commandmodinput/commandmodinputsetup/commandmodinput",
            ...
            success: function(text) {
                ...
                window.location.href = '../command_ta/landing';
